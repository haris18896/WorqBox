...
export default function Login() {
  ...
  return (
    <View style={fallbackStyles.container}>
      <Text style={fallbackStyles.title}>Welcome to WorqBox</Text>
      <Text style={fallbackStyles.subtitle}>Sign in to your account</Text>
      ...
      <View style={fallbackStyles.buttonContainer}>
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={fallbackStyles.primaryButtonText}>Go to Register</Text>
        </TouchableOpacity>
